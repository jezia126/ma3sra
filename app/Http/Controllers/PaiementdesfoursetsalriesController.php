...
use App\Models\Paiementdesfoursetsalries;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PaiementdesfoursetsalriesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'paiementdesfoursetsalries';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Paiementdesfoursetsalries();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'paiementdesfoursetsalries',
	...
	public static function display(  )
	{
		...
		$model  = new Paiementdesfoursetsalries();
		$info = $model::makeInfo('paiementdesfoursetsalries');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('paiementdesfoursetsalries.public.view',$data);			
			}			
		} 
		else {
			...
			return view('paiementdesfoursetsalries.public.index',$data);	
		}
