...
use App\Models\Lotdestockageolive;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LotdestockageoliveController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'lotdestockageolive';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Lotdestockageolive();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'lotdestockageolive',
	...
	public static function display(  )
	{
		...
		$model  = new Lotdestockageolive();
		$info = $model::makeInfo('lotdestockageolive');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('lotdestockageolive.public.view',$data);			
			}			
		} 
		else {
			...
			return view('lotdestockageolive.public.index',$data);	
		}
