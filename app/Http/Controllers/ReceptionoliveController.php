...
class ReceptionoliveController extends Controller {
	...
	public $module = 'receptionolive';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Receptionolive();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'receptionolive',
	...
	public static function display(  )
	{
		...
		$model  = new Receptionolive();
		$info = $model::makeInfo('receptionolive');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('receptionolive.public.view',$data);			
			}			
		} 
		else {
			...
			return view('receptionolive.public.index',$data);	
		}
