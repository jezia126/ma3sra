...
use App\Models\Gestionregionolives;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class GestionregionolivesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'gestionregionolives';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Gestionregionolives();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'gestionregionolives',
	...
	public static function display(  )
	{
		...
		$model  = new Gestionregionolives();
		$info = $model::makeInfo('gestionregionolives');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gestionregionolives.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gestionregionolives.public.index',$data);	
		}
