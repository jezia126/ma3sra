...
use App\Models\Stohuiachecite;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class StohuiacheciteController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'stohuiachecite';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Stohuiachecite();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'stohuiachecite',
	...
	public static function display(  )
	{
		...
		$model  = new Stohuiachecite();
		$info = $model::makeInfo('stohuiachecite');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('stohuiachecite.public.view',$data);			
			}			
		} 
		else {
			...
			return view('stohuiachecite.public.index',$data);	
		}
