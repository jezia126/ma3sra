...
use App\Models\Ouvrirloprohui;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OuvrirloprohuiController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ouvrirloprohui';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ouvrirloprohui();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ouvrirloprohui',
	...
	public static function display(  )
	{
		...
		$model  = new Ouvrirloprohui();
		$info = $model::makeInfo('ouvrirloprohui');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ouvrirloprohui.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ouvrirloprohui.public.index',$data);	
		}
