...
use App\Models\Logististockhuilache;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LogististockhuilacheController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'logististockhuilache';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Logististockhuilache();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'logististockhuilache',
	...
	public static function display(  )
	{
		...
		$model  = new Logististockhuilache();
		$info = $model::makeInfo('logististockhuilache');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('logististockhuilache.public.view',$data);			
			}			
		} 
		else {
			...
			return view('logististockhuilache.public.index',$data);	
		}
