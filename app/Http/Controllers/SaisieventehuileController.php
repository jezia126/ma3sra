...
use App\Models\Saisieventehuile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class SaisieventehuileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'saisieventehuile';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Saisieventehuile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'saisieventehuile',
	...
	public static function display(  )
	{
		...
		$model  = new Saisieventehuile();
		$info = $model::makeInfo('saisieventehuile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('saisieventehuile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('saisieventehuile.public.index',$data);	
		}
