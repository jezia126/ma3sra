...
class GestiondescaissesplastiquesController extends Controller {
	...
	public $module = 'gestiondescaissesplastiques';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Gestiondescaissesplastiques();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'gestiondescaissesplastiques',
	...
	public static function display(  )
	{
		...
		$model  = new Gestiondescaissesplastiques();
		$info = $model::makeInfo('gestiondescaissesplastiques');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gestiondescaissesplastiques.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gestiondescaissesplastiques.public.index',$data);	
		}
