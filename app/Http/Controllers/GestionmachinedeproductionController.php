...
use App\Models\Gestionmachinedeproduction;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class GestionmachinedeproductionController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'gestionmachinedeproduction';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Gestionmachinedeproduction();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'gestionmachinedeproduction',
	...
	public static function display(  )
	{
		...
		$model  = new Gestionmachinedeproduction();
		$info = $model::makeInfo('gestionmachinedeproduction');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gestionmachinedeproduction.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gestionmachinedeproduction.public.index',$data);	
		}
