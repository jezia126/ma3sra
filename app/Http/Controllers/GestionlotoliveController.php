...
use App\Models\Gestionlotolive;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class GestionlotoliveController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'gestionlotolive';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Gestionlotolive();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'gestionlotolive',
	...
	public static function display(  )
	{
		...
		$model  = new Gestionlotolive();
		$info = $model::makeInfo('gestionlotolive');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gestionlotolive.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gestionlotolive.public.index',$data);	
		}
