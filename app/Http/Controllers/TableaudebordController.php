...
class TableaudebordController extends Controller {
	...
	public $module = 'tableaudebord';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Tableaudebord();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'tableaudebord',
	...
	public static function display(  )
	{
		...
		$model  = new Tableaudebord();
		$info = $model::makeInfo('tableaudebord');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('tableaudebord.public.view',$data);			
			}			
		} 
		else {
			...
			return view('tableaudebord.public.index',$data);	
		}
