...
use App\Models\Tierscrediteurs;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class TierscrediteursController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'tierscrediteurs';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Tierscrediteurs();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'tierscrediteurs',
	...
	public static function display(  )
	{
		...
		$model  = new Tierscrediteurs();
		$info = $model::makeInfo('tierscrediteurs');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('tierscrediteurs.public.view',$data);			
			}			
		} 
		else {
			...
			return view('tierscrediteurs.public.index',$data);	
		}
