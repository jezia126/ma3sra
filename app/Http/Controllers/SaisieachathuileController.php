...
use App\Models\Saisieachathuile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class SaisieachathuileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'saisieachathuile';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Saisieachathuile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'saisieachathuile',
	...
	public static function display(  )
	{
		...
		$model  = new Saisieachathuile();
		$info = $model::makeInfo('saisieachathuile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('saisieachathuile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('saisieachathuile.public.index',$data);	
		}
