...
use App\Models\Receptionsortiehuile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ReceptionsortiehuileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'receptionsortiehuile';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Receptionsortiehuile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'receptionsortiehuile',
	...
	public static function display(  )
	{
		...
		$model  = new Receptionsortiehuile();
		$info = $model::makeInfo('receptionsortiehuile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('receptionsortiehuile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('receptionsortiehuile.public.index',$data);	
		}
