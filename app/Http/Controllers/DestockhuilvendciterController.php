...
use App\Models\Destockhuilvendciter;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DestockhuilvendciterController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'destockhuilvendciter';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Destockhuilvendciter();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'destockhuilvendciter',
	...
	public static function display(  )
	{
		...
		$model  = new Destockhuilvendciter();
		$info = $model::makeInfo('destockhuilvendciter');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('destockhuilvendciter.public.view',$data);			
			}			
		} 
		else {
			...
			return view('destockhuilvendciter.public.index',$data);	
		}
