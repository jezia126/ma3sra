...
use App\Models\Natureolive;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class NatureoliveController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'natureolive';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Natureolive();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'natureolive',
	...
	public static function display(  )
	{
		...
		$model  = new Natureolive();
		$info = $model::makeInfo('natureolive');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('natureolive.public.view',$data);			
			}			
		} 
		else {
			...
			return view('natureolive.public.index',$data);	
		}
