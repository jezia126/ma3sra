...
use App\Models\Encaissementsurlesclients;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class EncaissementsurlesclientsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'encaissementsurlesclients';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Encaissementsurlesclients();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'encaissementsurlesclients',
	...
	public static function display(  )
	{
		...
		$model  = new Encaissementsurlesclients();
		$info = $model::makeInfo('encaissementsurlesclients');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('encaissementsurlesclients.public.view',$data);			
			}			
		} 
		else {
			...
			return view('encaissementsurlesclients.public.index',$data);	
		}
