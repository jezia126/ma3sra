...
use App\Models\Transferthuile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class TransferthuileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'transferthuile';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Transferthuile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'transferthuile',
	...
	public static function display(  )
	{
		...
		$model  = new Transferthuile();
		$info = $model::makeInfo('transferthuile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('transferthuile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('transferthuile.public.index',$data);	
		}
