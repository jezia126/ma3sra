...
use App\Models\Stockagehuileciter;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class StockagehuileciterController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'stockagehuileciter';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Stockagehuileciter();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'stockagehuileciter',
	...
	public static function display(  )
	{
		...
		$model  = new Stockagehuileciter();
		$info = $model::makeInfo('stockagehuileciter');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('stockagehuileciter.public.view',$data);			
			}			
		} 
		else {
			...
			return view('stockagehuileciter.public.index',$data);	
		}
