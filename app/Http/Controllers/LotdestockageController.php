...
use App\Models\Lotdestockage;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LotdestockageController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'lotdestockage';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Lotdestockage();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'lotdestockage',
	...
	public function execution(){
		return view('executiontrituration');
	}	
	...
	public static function display(  )
	{
		...
		$model  = new Lotdestockage();
		$info = $model::makeInfo('lotdestockage');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('lotdestockage.public.view',$data);			
			}			
		} 
		else {
			...
			return view('lotdestockage.public.index',$data);	
		}
