...
use App\Models\Logististockhuivendci;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LogististockhuivendciController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'logististockhuivendci';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Logististockhuivendci();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'logististockhuivendci',
	...
	public static function display(  )
	{
		...
		$model  = new Logististockhuivendci();
		$info = $model::makeInfo('logististockhuivendci');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('logististockhuivendci.public.view',$data);			
			}			
		} 
		else {
			...
			return view('logististockhuivendci.public.index',$data);	
		}
