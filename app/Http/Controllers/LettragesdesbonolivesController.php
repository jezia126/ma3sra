...
use App\Models\Lettragesdesbonolives;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LettragesdesbonolivesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'lettragesdesbonolives';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Lettragesdesbonolives();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'lettragesdesbonolives',
	...
	public static function display(  )
	{
		...
		$model  = new Lettragesdesbonolives();
		$info = $model::makeInfo('lettragesdesbonolives');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('lettragesdesbonolives.public.view',$data);			
			}			
		} 
		else {
			...
			return view('lettragesdesbonolives.public.index',$data);	
		}
