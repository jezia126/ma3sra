...
use App\Models\Executiontrituration;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ExecutiontriturationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'executiontrituration';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Executiontrituration();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'executiontrituration',
	...
	public static function display(  )
	{
		...
		$model  = new Executiontrituration();
		$info = $model::makeInfo('executiontrituration');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('executiontrituration.public.view',$data);			
			}			
		} 
		else {
			...
			return view('executiontrituration.public.index',$data);	
		}
