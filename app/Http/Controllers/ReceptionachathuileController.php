...
use App\Models\Receptionachathuile;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ReceptionachathuileController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'receptionachathuile';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Receptionachathuile();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'receptionachathuile',
	...
	public static function display(  )
	{
		...
		$model  = new Receptionachathuile();
		$info = $model::makeInfo('receptionachathuile');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('receptionachathuile.public.view',$data);			
			}			
		} 
		else {
			...
			return view('receptionachathuile.public.index',$data);	
		}
