...
use App\Models\Lettragesdesbonolivesencaismt;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class LettragesdesbonolivesencaismtController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'lettragesdesbonolivesencaismt';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Lettragesdesbonolivesencaismt();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'lettragesdesbonolivesencaismt',
	...
	public static function display(  )
	{
		...
		$model  = new Lettragesdesbonolivesencaismt();
		$info = $model::makeInfo('lettragesdesbonolivesencaismt');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('lettragesdesbonolivesencaismt.public.view',$data);			
			}			
		} 
		else {
			...
			return view('lettragesdesbonolivesencaismt.public.index',$data);	
		}
