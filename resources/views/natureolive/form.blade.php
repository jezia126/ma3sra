...
<div class="card">
	...
	{!! Form::open(array('url'=>'natureolive?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> nature olive</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("natureolive/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
