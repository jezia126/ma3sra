		 ...
		 {!! Form::open(array('url'=>'gestionlotdestockageolive', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
					...
					{!! Form::text('date_de_fin_execution', $row['date_de_fin_execution'],array('class'=>'form-control form-control-sm date')) !!} 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										  <select name='tiers' rows='5' id='tiers' class='select2 '   ></select> 
										 </div> 
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										  <select name='nombre_caisse[]' multiple rows='5' id='nombre_caisse' class='select2 '   ></select> 
										 </div> 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#tiers").jCombo("{!! url('gestionlotdestockageolive/comboselect?filter=tb_reception_olive:id:code_tiers|tiers_crediteur') !!}",
		{  selected_value : '{{ $row["tiers"] }}' });
		
		$("#nombre_caisse").jCombo("{!! url('gestionlotdestockageolive/comboselect?filter=tb_gestion_des_caisses_plastique:code:code') !!}",
		{  selected_value : '{{ $row["nombre_caisse"] }}' });
